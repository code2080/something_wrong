...
const updateObjectRequestFlow = {
  request: () => ({ type: types.FETCH_OBJECT_REQUEST_REQUEST }),
  success: response => ({ type: types.FETCH_OBJECT_REQUEST_SUCCESS, payload: response }),
  failure: err => ({ type: types.FETCH_OBJECT_REQUEST_FAILURE, ...err }),
};
