...
const NumberFilter = ({ searchValue, searchCriteria, fieldLabel, typeLabel, element, payload, teCoreAPI }) => {
...
NumberFilter.defaultProps = {
  searchValue: '',
  searchCriteria: searchCriteriaNumberProps[searchCriteriaNumber.EQUAL_TO].label,
  fieldLabel: null,
  typeLabel: null,
  element: {},
};
