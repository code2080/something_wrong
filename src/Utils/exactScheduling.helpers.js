import { activityValueTypes, activityValueTypeProps } from '../Constants/activityValueTypes.constants';
import { TECoreFieldModel, TECoreObjectModel, TECoreReservationModel } from '../Models/TECoreReservation.model';
...
const convertValuesToReservationProps = activity => (activity.values || []).reduce((prev, activityValue) => ({
  ...prev,
...
export const scheduleActivityExact = (activity, teCoreScheduleFn, callback) => {
   ...
   */
  return teCoreScheduleFn({ reservation, callback });
};
