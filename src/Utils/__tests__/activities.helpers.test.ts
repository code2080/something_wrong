...
describe('Activity helpers tests', () => {
  ...
  describe('Activities in joint teaching', () => {
    it('Should return all unique activity values', () => {
      ...
      const allTiming = getAllValuesFromActivities(ConflictType.TIMING, activities);
      const allValues = getAllValuesFromActivities(ConflictType.VALUES, activities);
      ...
      const allValues2 = getAllValuesFromActivities(ConflictType.VALUES, activities);
